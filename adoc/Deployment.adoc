...
===== Stage 1 Discovery
During this stage, all hardware in your cluster are detected and necessary information are collected for the Ceph configuration.
----
...
[TIP]
====
You may need to play with the proposal population command with different arguments for several times to get what you really want.
...
----
Pass "name=myprofile" to the command to name the storage profile. This will result in a "profile-myprofile" subdirectory been created to save the new proposal.
====
